...
2. **Creates** `~/.openclaw/agent_instructions.active`
...
1. **Creates** `~/.openclaw/agent_shutdown.signal`
2. **Writes** a shutdown message declaring instructions void
3. **Removes** `~/.openclaw/agent_instructions.active`
...
|------|--------------|----------|---------|
| `~/.openclaw/agent_instructions.active` | Startup | Full AGENT_INSTRUCTIONS.txt + metadata | Agent learns how to use voice loop |
| `~/.openclaw/agent_shutdown.signal` | Shutdown | Shutdown message | Agent knows voice loop stopped |
...
def check_voice_loop():
    ...
    active_file = Path.home() / ".openclaw" / "agent_instructions.active"
    shutdown_file = Path.home() / ".openclaw" / "agent_shutdown.signal"
...
============================================================
Monitoring: ~/.openclaw/mouth_status.txt
Signal file: ~/.openclaw/ears_pause.signal

============================================================
📢 AGENT INSTRUCTIONS ACTIVATED
============================================================
Instructions file: ~/.openclaw/agent_instructions.active
Agent should read this file to learn about voice loop usage
============================================================

✅ Agent instructions sent
   Agent should read: ~/.openclaw/agent_instructions.active
...
✅ Agent shutdown notification sent
   Agent should read: ~/.openclaw/agent_shutdown.signal
...
# Terminal 2
cat ~/.openclaw/agent_instructions.active
...
# Terminal 2
cat ~/.openclaw/agent_shutdown.signal
# Should show shutdown message

ls ~/.openclaw/agent_instructions.active
...
active = Path.home() / ".openclaw" / "agent_instructions.active"
shutdown = Path.home() / ".openclaw" / "agent_shutdown.signal"
...
- Uses ~/.openclaw directory (same as other systems)
...
Agents just need to check for `~/.openclaw/agent_instructions.active` on startup!
